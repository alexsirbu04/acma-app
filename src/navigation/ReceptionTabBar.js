...
export default class ReceptionTabBar extends Component {
  renderIcons() {
    const { navigate, state } = this.props.navigation;
    const { routes } = state;
    const iconNameFocus = ['ios-home', 'ios-checkbox', 'ios-person'];
    const iconName = ['ios-home-outline', 'ios-checkbox-outline', 'ios-person-outline'];
